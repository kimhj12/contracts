...
//             if(from == get_self()) {
//                 Receive receiver(get_self(), get_self().value);
...
//                     });
//                 } else {
//                 Send sender(get_self(), get_self().value);
...
//         typedef multi_index<"asend"_n, record> Send;
//         typedef multi_index<"areceive"_n, record> Receive;
// };
